...
export function AttemptPage() {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#f8f4ee_0%,#f5f0e8_100%)]">
      <header className="sticky top-0 z-20 border-b border-[var(--color-ink)]/10 bg-[rgba(248,244,238,0.95)] backdrop-blur">
        <div className="mx-auto flex w-full max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-3">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Button type="button" variant="secondary" className="lg:hidden" onClick={() => setPaletteOpen((value) => !value)}>
              Palette
            </Button>
      ...
      <div className="mx-auto grid w-full max-w-6xl gap-4 px-4 py-4 lg:grid-cols-[minmax(0,1fr)_280px]">
        <main className="rounded-md border border-[var(--color-ink)]/10 bg-white/75 p-4 sm:p-6">
          {error ? (
            <div className="mb-4">
              <ErrorState message={error} />
            </div>
          ...
          <div className="mt-6 flex flex-wrap gap-2 border-t border-[var(--color-ink)]/10 pt-4">
            <Button
              type="button"
              variant="secondary"
        ...
        <div className={[paletteOpen ? 'block' : 'hidden', 'lg:block'].join(' ')}>
          <QuestionPalette
